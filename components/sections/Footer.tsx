...
const Footer = () => {
  return (
    <footer id="contact" className="overflow-x-hidden  py-4 px-4 mt-20 top-10 flex items-center bg-slate-800 max-w-7xl mx-auto justify-center flex-col gap-4 rounded-3xl">
