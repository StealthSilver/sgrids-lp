...
const Content = () => {
  ...
  return (
    <section id="features" className="overflow-x-hidden  py-12 px-4 flex flex-col items-center justify-center mx-4 bg-black rounded-2xl shadow-md md:gap-12 md:mb-16 ">
        ...
        <div className="flex flex-wrap justify-center items-start">
          ...
          >
            ...
            <Image
              ...
              className="mb-3 z-10"
            />
            <h2 className="text-xl font-khula font-semibold text-white mb-1 z-10">{card.title}</h2>
            <p className="text-white text-sm opacity-80 font-catamaran z-10">{card.description}</p>
          </div>
