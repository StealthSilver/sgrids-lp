...
const AnimatedFlowSVG = () => {
  ...
  const DuplicatedRect = (props: React.SVGProps<SVGRectElement>) => (
    <>
      ...
      <rect {...props} stroke="url(#scrollGradient)" style={{ opacity: scrollProgress }} />
    </>
  );
  ...
  const DuplicatedPath = (props: React.SVGProps<SVGPathElement>) => (
    <>
      ...
      <path {...props} stroke="url(#scrollGradient)" style={{ opacity: scrollProgress }} />
    </>
  );
  ...
  return (
    ...
    >
      ...
      <DuplicatedRect x={0.5} y={0.5} width={82} height={87} rx={19.5} strokeWidth={1} />
      <DuplicatedPath
      ...
      <DuplicatedPath
        ...
        strokeWidth={1}
      />
      <DuplicatedPath d="M123 843V1107C123 1118.05 131.954 1127 143 1127H169" strokeWidth={1} />
      ...
      <DuplicatedRect x={171.5} y={87.5} width={201} height={286} rx={19.5} strokeWidth={1} />
      <DuplicatedRect x={205.5} y={129.5} width={134} height={26} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={15.5} y={555.5} width={201} height={286} rx={19.5} strokeWidth={1} />
      <DuplicatedRect x={33.5} y={611.5} width={105} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={157.5} y={611.5} width={40} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={157.5} y={663.5} width={40} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={157.5} y={715.5} width={40} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={157.5} y={767.5} width={40} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={33.5} y={663.5} width={105} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={33.5} y={715.5} width={105} height={27} rx={9.5} strokeWidth={1} />
      <DuplicatedRect x={33.5} y={767.5} width={105} height={27} rx={9.5} strokeWidth={1} />
      ...
      <DuplicatedRect x={194.5} y={1279.5} width={107} height={14} rx={3.5} strokeWidth={1} />
    </svg>
  );
};
